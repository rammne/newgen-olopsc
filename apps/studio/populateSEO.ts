...
const singletonSEO: Record<
  string,
  {_type: string; documentId: string; title: string; description: string; keywords: string[]}
> = {
  homePage: {
    _type: 'homePage',
    documentId: 'homePage',
    ...
    description:
      'Our Lady of Perpetual Succor College (OLOPSC) — A premier educational institution in Marikina City offering quality education from Preschool to College. Enroll now and be part of the OLOPSC family.',
    keywords: [
      'OLOPSC',
...
const collegeProgramSEO: Record<
  string,
  {documentId: string; title: string; description: string; keywords: string[]}
> = {
  computingStudies: {
