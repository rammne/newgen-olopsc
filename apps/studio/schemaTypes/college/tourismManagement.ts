...
export const tourismManagement = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'units', title: 'Total Units', type: 'string', initialValue: '156 Units' }),
        defineField({ name: 'format', title: 'Format', type: 'string', initialValue: 'Hybrid + Practicum' }),
      ]
    }),
    ...
    defineField({
      ...
      fields: [
        defineField({
          name: 'lab', title: 'Clinical Lab / Simulation Room Image', type: 'image', options: { hotspot: true },
          fields: [defineField({ name: 'alt', title: 'Alt Text', type: 'string' })]
        }),
        defineField({
  ...
  preview: {
    prepare() {
      return { title: 'Tourism Management Program Page' }
    },
  },
})
