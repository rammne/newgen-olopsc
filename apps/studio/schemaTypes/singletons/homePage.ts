...
export const homePage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'object',
      description: 'Showcase monthly highlights by department — displayed as a filterable grid on the homepage',
      group: 'content',
      fields: [
        defineField({
          name: 'title',
          title: 'Section Title',
          type: 'string',
          initialValue: 'Monthly Highlights',
        }),
        defineField({
          name: 'subtitle',
          title: 'Subtitle',
        ...
        defineField({
          ...
          title: 'Highlights',
          type: 'array',
          of: [{ type: 'monthlyHighlight' }],
          description: 'Add monthly highlight entries with photos, descriptions, and department tags',
        }),
      ],
    }),
    defineField({
